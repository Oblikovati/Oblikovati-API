...
/// </summary>
public interface EllipseRadiusDimConstraintProxy
{
    /// <summary>
    ...
    /// <summary>
    /// Property that returns whether the proxy constraint is controlling the major or minor radius of the ellipse. Returns true if it is the major radius.
    /// </summary>
    bool MajorRadius { get; }
    /// <summary>
    /// Gets the object in the context of the definition instead of the containing assembly.
    /// </summary>
    EllipseRadiusDimConstraint NativeObject { get; }
    /// <summary>
