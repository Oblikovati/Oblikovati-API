...
/// </summary>
public interface PointWorkPointDef
{
    /// <summary>
    ...
    /// <summary>
    /// Property that returns the point of a work point that is defined to be coincident to the point. This object can be a Vertex or SketchPoint object.
    /// </summary>
    object Point { get; }
}
