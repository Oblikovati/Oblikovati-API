...
/// </summary>
public interface ModelWeldingSymbolProxy
{
    /// <summary>
    ...
    /// <summary>
    /// Gets and sets the ModelWeldingSymbolDefinitions object associated with this symbol.
    /// </summary>
    ModelWeldingSymbolDefinitions Definitions { get; set; }
    /// <summary>
    /// Use F1 key to display help topic.
    /// </summary>
    ModelWeldingSymbol NativeObject { get; }
    /// <summary>
    /// Use F1 key to display help topic.
    /// </summary>
