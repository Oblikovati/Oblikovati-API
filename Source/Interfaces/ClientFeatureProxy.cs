...
/// </summary>
public interface ClientFeatureProxy
{
    /// <summary>
    ...
    string ClientId { get; }
    /// <summary>
    /// Property that returns the ClientFeatureDefinition object that specifies the various inputs used to create the feature.
    /// </summary>
    ClientFeatureDefinition Definition { get; }
    /// <summary>
    /// Property that returns the BrowserNode object in the model browser associated with this client feature.
    /// </summary>
    BrowserNode BrowserNode { get; }
    /// <summary>
    /// Read-write property that gets and sets the collection of Parameters that are to be hidden from the user.
    /// </summary>
    ObjectCollection HiddenParameters { get; set; }
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    ...
    /// </summary>
    ClientFeature NativeObject { get; }
    /// <summary>
