...
/// <summary>
/// The CoreCavityFeature object represents a modeling feature for generating core/cavity surface bodies.
/// </summary>
public interface CoreCavityFeature
{
    /// <summary>
    ...
    /// <summary>
    /// Property that returns the SurfaceBody object that represents the core portion of the mold.
    /// </summary>
    SurfaceBody Core { get; }
    /// <summary>
    /// Property that returns the SurfaceBody object that represents the cavity portion of the mold.
    /// </summary>
    SurfaceBody Cavity { get; }
    /// <summary>
    /// Property that gets and set the CoreCavityDefinition object associated with this core-cavity feature.
    /// </summary>
    CoreCavityDefinition Definition { get; set; }
    /// <summary>
