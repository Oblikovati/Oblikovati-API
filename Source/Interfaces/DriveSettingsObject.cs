...
public interface DriveSettingsObject
{
    /// <summary>
    ...
    [PreserveSig]
    void GetIncrement([Out] out IncrementTypeEnum IncrementType, [Out] [MarshalAs(UnmanagedType.BStr)] out string Increment);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    [PreserveSig]
    ...
    /// <param name="Increment">Increment</param>
    [PreserveSig]
    void SetIncrement([In] IncrementTypeEnum IncrementType, [In] [MarshalAs(UnmanagedType.BStr)] string Increment);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
