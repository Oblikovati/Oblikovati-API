...
public interface IRxCurve2dEvaluator
{
    ...
    /// <param name="pSolutionNatures">pSolutionNatures</param>
    void GetParamAtPoint([In] uint nPoints, [In] ref double pPoints, [In] [Out] ref double pGuessParams, [In] [Out] ref double pMaxDeviations, [In] [Out] ref double pParams, [In] [Out] ref SolutionNatureEnum pSolutionNatures);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
