...
public interface IRxCurve2dEvaluator
{
    ...
    void GetParamAtPoint([In] uint nPoints, [In] ref double pPoints, [Out] out double pGuessParams, [Out] out double pMaxDeviations, [Out] out double pParams, [Out] out SolutionNatureEnum pSolutionNatures);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
