...
/// <summary>
/// The KnitFeature object represents a knit feature on a part. Knit features connect edge-matched surfaces together to create a quilt.
/// </summary>
public interface KnitFeature
{
    /// <summary>
    ...
    /// <summary>
    /// Gets and sets whether to maintain the resulting body as a surface in the case where the resulting body of the stitch operation could potentially be a solid.
    /// </summary>
    bool MaintainAsSurface { get; set; }
    /// <summary>
    /// Gets and sets the maximum distance between the edges of two faces before being knit together.
    /// </summary>
    double MaximumTolerance { get; set; }
    /// <summary>
