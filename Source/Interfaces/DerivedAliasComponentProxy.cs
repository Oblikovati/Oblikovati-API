...
/// </summary>
public interface DerivedAliasComponentProxy
{
    /// <summary>
    ...
    /// <summary>
    /// Read-only property that returns the full filename of the derived Alias file.
    /// </summary>
    string ReferencedAliasFullFilename { get; }
    /// <summary>
    /// Gets the object in the context of the definition instead of the containing assembly.
    /// </summary>
    DerivedAliasComponent NativeObject { get; }
    /// <summary>
