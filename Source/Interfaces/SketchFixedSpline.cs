...
/// <summary>
/// The SketchFixedSpline object represents a fixed spline within a sketch. These splines are created using the geometry definition (BSplineCurve2d). See the article in the overviews section.
/// </summary>
public interface SketchFixedSpline
{
    /// <summary>
    ...
    bool Closed { get; }
    /// <summary>
    /// Gets and sets the color applied to this sketch fixed spline.
    /// </summary>
    Color OverrideColor { get; set; }
    /// <summary>
    /// Gets and sets the LineType applied to this sketch fixed spline.
    /// </summary>
    LineTypeEnum LineType { get; set; }
    /// <summary>
    /// Gets and sets the LineWeight applied to this sketch fixed spline.
    /// </summary>
    double LineWeight { get; set; }
    /// <summary>
    /// Gets and sets the LineScale applied to this sketch fixed spline.
    /// </summary>
    double LineScale { get; set; }
    /// <summary>
    /// Gets and sets the LineDefinitionSpace applied to this sketch fixed spline.
    /// </summary>
    ...
    /// </summary>
    /// <param name="SplineCurve">Input BSplineCurve2d geometry object that contains the definition of a curve that will be used to redefine the spline.</param>
    ...
    [PreserveSig]
    void Edit([In] [MarshalAs(UnmanagedType.Interface)] BSplineCurve2d SplineCurve, [In] [MarshalAs(UnmanagedType.Struct)] object? StartPoint = default, [In] [MarshalAs(UnmanagedType.Struct)] object? EndPoint = default);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    ...
    /// <summary>
    /// Method that converts the fixed spline to a SketchSpline object.
    /// </summary>
    /// <returns></returns>
    [PreserveSig]
