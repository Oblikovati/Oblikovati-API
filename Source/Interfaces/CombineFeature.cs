...
/// <summary>
/// The CombineFeature object represents an existing combine feature in an Inventor part document.
/// </summary>
public interface CombineFeature
{
    /// <summary>
    ...
    /// <summary>
    /// Property that returns whether the tool bodies were retained during the creation of the combine feature.
    /// </summary>
    bool KeepToolBodies { get; }
    /// <summary>
    ...
    /// <summary>
    /// Property that returns the input tool bodies used to create the feature. If the KeepToolBodies property returns False, the end of part marker needs to be moved above this feature in order to query the bodies.
    /// </summary>
    SurfaceBodies ToolBodies { get; }
    /// <summary>
    ...
    [PreserveSig]
    void Edit([In] [MarshalAs(UnmanagedType.Interface)] SurfaceBody BaseBody, [In] [MarshalAs(UnmanagedType.Interface)] ObjectCollection ToolBodies, [In] PartFeatureOperationEnum Operation);
}
