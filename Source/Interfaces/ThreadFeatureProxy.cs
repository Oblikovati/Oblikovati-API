...
/// </summary>
public interface ThreadFeatureProxy
{
    /// <summary>
    ...
    /// </summary>
    Parameter ThreadOffset { get; }
    /// <summary>
    /// Property that returns a indicating the thread type.
    /// </summary>
    ThreadTypeEnum ThreadInfoType { get; }
    /// <summary>
    ...
    /// </summary>
    ThreadInfo ThreadInfo { get; set; }
    /// <summary>
    /// Gets the object in the context of the definition instead of the containing assembly.
    /// </summary>
    ThreadFeature NativeObject { get; }
    /// <summary>
    ...
    /// </summary>
    /// <param name="ThreadDepth">Input Variant that specifies the total depth of the thread, as measured from its starting edge.</param>
    /// <param name="StartEdge">Input Edge that specifies the point at which to begin thread.</param>
    [PreserveSig]
    void SetThreadDepth([In] [MarshalAs(UnmanagedType.Struct)] object ThreadDepth, [In] [MarshalAs(UnmanagedType.Interface)] Edge StartEdge);
}
