...
/// </summary>
public interface DrawingSketch
{
    /// <summary>
    ...
    /// </summary>
    TextBoxes _TextBoxes { get; }
    /// <summary>
    /// Gets the profiles collection associated with this drawing sketch.
    /// </summary>
    Profiles Profiles { get; }
    /// <summary>
    /// </summary>
    SketchFillRegions SketchFillRegions { get; }
    /// <summary>
    /// Read-only property that returns the SketchHatchRegions collection object.
    /// </summary>
    SketchHatchRegions SketchHatchRegions { get; }
    /// <summary>
    ...
    /// </summary>
    /// <param name="SheetCoordinate">Input object of a point within sheet space.</param>
    /// <returns></returns>
    [PreserveSig]
    Point2d SheetToSketchSpace([In] [MarshalAs(UnmanagedType.Interface)] Point2d SheetCoordinate);
    /// <summary>
    ...
    /// </summary>
    /// <param name="SketchCoordinate">Input object of a point within sketch space.</param>
    /// <returns></returns>
    [PreserveSig]
    Point2d SketchToSheetSpace([In] [MarshalAs(UnmanagedType.Interface)] Point2d SketchCoordinate);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    ...
    /// <summary>
    /// Method that sets the automatic centerline and center mark settings for this sketch and creates the centerlines and center marks defined by the settings. The centerlines and center marks that were created are returned.
    /// </summary>
    /// <param name="AutomatedCenterlineSettings">Optional input AutomatedCenterlineSettings object that defines the automatic center line and center mark creation settings for this sketch.
    /// If this argument is omitted the following rules apply. If automated centerlines and center marks have not been created for this sketch then this argument will default to the settings defined by the drawing settings. If this sketch has had automatic centerlines and center marks created, then the values used for the previous created are used.</param>
    /// <returns></returns>
    [PreserveSig]
