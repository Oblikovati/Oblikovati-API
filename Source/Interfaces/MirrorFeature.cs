...
/// <summary>
/// The MirrorFeature object represents mirror pattern feature objects.
/// </summary>
public interface MirrorFeature
{
    /// <summary>
    ...
    /// <summary>
    /// Gets and sets whether all the resulting surfaces are visible or not.
    /// </summary>
    bool SurfacesVisible { get; set; }
    /// <summary>
    /// Gets and sets whether all the resulting surfaces are opaque or transparent.
    /// </summary>
    bool SurfacesOpaque { get; set; }
    /// <summary>
    /// Property that returns the features that were created for this mirror. These can be work planes, work axes, work points and work surfaces.
    /// </summary>
    ObjectsEnumerator ResultFeatures { get; }
    /// <summary>
    /// Gets the FeaturePatternElements collection that contains the elements created by this pattern.
    /// </summary>
    FeaturePatternElements PatternElements { get; }
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    bool NewBodyOperation { get; set; }
    /// <summary>
    /// Read-write property that gets and sets the MirrorFeatureDefinition object associated with this feature.
    /// </summary>
    MirrorFeatureDefinition Definition { get; set; }
    /// <summary>
    ...
    /// </summary>
    [PreserveSig]
    void AddParticipant([In] [MarshalAs(UnmanagedType.Interface)] ComponentOccurrence Occurrenc);
}
