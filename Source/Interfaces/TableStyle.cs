...
public interface TableStyle
{
    ...
    /// </summary>
    /// <param name="Title">Optional input String that specifies the column title. If not specified, a default name is used.</param>
    ...
    [PreserveSig]
    void AddColumn([In] [MarshalAs(UnmanagedType.BStr)] string? Title = "", [In] double? Width = default, [In] HorizontalTextAlignmentEnum? TitleHorizontalJustification = HorizontalTextAlignmentEnum.kAlignTextCenter, [In] HorizontalTextAlignmentEnum? ValueHorizontalJustification = HorizontalTextAlignmentEnum.kAlignTextCenter);
    /// <summary>
