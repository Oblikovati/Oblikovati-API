...
public interface IRxEnumVertices
{
    ...
    void Next([In] uint nBodies, [Out] [MarshalAs(UnmanagedType.Interface)] out IRxVertex ppBodies, [Out] out uint pnBodiesFetched);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    ...
    void Clone([Out] [MarshalAs(UnmanagedType.Interface)] out IRxEnumVertices ppEnum);
}
