...
/// </summary>
public interface ExtrudeFeatureProxy
{
    /// <summary>
    ...
    /// <param name="ExtentDirection">ExtentDirection</param>
    [PreserveSig]
    void _SetToNextExtent([In] PartFeatureExtentDirectionEnum ExtentDirection);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    /// <param name="ExtentDirection">ExtentDirection</param>
