...
/// <summary>
/// The FaceFeature object represents a sheet metal face feature.
/// </summary>
public interface FaceFeature
{
    ...
    /// <summary>
    /// Property that returns the associated bend feature, if one exists. If there isn't an associated bend feature this property returns Nothing.
    /// </summary>
    BendFeature BendFeature { get; }
    /// <summary>
    /// Property that gets the FaceFeatureDefinition object associated with this face feature.
    /// </summary>
    FaceFeatureDefinition Definition { get; }
    /// <summary>
