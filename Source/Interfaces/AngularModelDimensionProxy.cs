...
/// </summary>
public interface AngularModelDimensionProxy
{
    /// <summary>
    ...
    /// </summary>
    ModelDimensionDefinition Definition { get; set; }
    /// <summary>
    /// Read-only property that gets the dimension value as defined in the model.
    /// </summary>
    double ModelValue { get; }
    /// <summary>
    /// Read-only property that returns the first extension line of the dimension. This property may return Nothing in cases where there are no extension lines.
    /// </summary>
    LineSegment ExtensionLineOne { get; }
    /// <summary>
    ...
    /// </summary>
    LineSegment ExtensionLineTwo { get; }
    /// <summary>
    /// Gets the object in the context of the definition instead of the containing assembly.
    /// </summary>
    AngularModelDimension NativeObject { get; }
    /// <summary>
