...
public interface UserParameter
{
    ...
    void Delete();
    /// <summary>
    /// Method that causes the parameter to be converted to a model parameter. The new ModelParameter object is returned.
    /// </summary>
    /// <returns></returns>
    [PreserveSig]
    ModelParameter ConvertToModelParameter();
    /// <summary>
    /// Method that causes the parameter to be converted to a reference parameter. The new ReferenceParameter object is returned.
    /// </summary>
    /// <returns></returns>
    [PreserveSig]
    ReferenceParameter ConvertToReferenceParameter();
}
