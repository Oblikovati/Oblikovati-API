...
/// <summary>
/// Part FaceOffset Feature Proxy Object.
/// </summary>
public interface FaceOffsetFeatureProxy
{
    /// <summary>
    ...
    /// Missing documentation! Help us documenting it!
    /// </summary>
    FaceOffsetDefinition _Definition { get; set; }
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    SurfaceBodies _OutputBodies { get; }
    /// <summary>
    /// Gets the object in the context of the definition instead of the containing assembly.
    /// </summary>
    FaceOffsetFeature NativeObject { get; }
    /// <summary>
    ...
    /// <param name="vOptimized">vOptimized</param>
    /// <param name="vTol">vTol</param>
    /// <param name="approxType">approxType</param>
    [PreserveSig]
    void _Edit([In] [MarshalAs(UnmanagedType.Interface)] FaceCollection InputFaces, [In] [MarshalAs(UnmanagedType.Struct)] object Distance, [In] bool reverse, [In] bool autoFaceChain, [In] bool vOptimized, [In] [MarshalAs(UnmanagedType.Struct)] object vTol, [In] FeatureApproximationTypeEnum approxType);
}
