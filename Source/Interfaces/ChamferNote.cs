...
public interface ChamferNote
{
    ...
    /// <summary>
    /// Property that returns that first chamfer edge. This can either be a linear DrawingCurve object or a SketchLine object from a sheet sketch.
    /// </summary>
    object ChamferEdgeOne { get; }
    /// <summary>
    /// Property that returns that second chamfer edge. This can either be a linear DrawingCurve object or a SketchLine object from a sheet sketch.
    /// </summary>
    object ChamferEdgeTwo { get; }
    /// <summary>
    /// Gets and sets the fully formatted string that defines the contents of the chamfer note.
    /// </summary>
    string FormattedChamferNote { get; set; }
    /// <summary>
    /// Gets and sets whether to display the chamfer note value in the note.
    /// </summary>
