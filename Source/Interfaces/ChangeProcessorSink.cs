...
public interface ChangeProcessorSink
{
    ...
    [PreserveSig]
    void OnExecute([In] [MarshalAs(UnmanagedType.Interface)] _Document Document, [In] [MarshalAs(UnmanagedType.Interface)] NameValueMap Context, [Out] out bool Succeeded);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    /// <param name="Document">Document</param>
