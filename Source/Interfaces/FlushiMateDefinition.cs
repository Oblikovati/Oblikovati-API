...
/// <summary>
/// The FlushiMateDefinition object represents a flush iMate definition. It is derived from the iMateDefinition object.
/// </summary>
public interface FlushiMateDefinition
{
    /// <summary>
    ...
    /// <summary>
    /// Property that returns the Parameter object that controls the offset of the flush iMate definition.
    /// </summary>
    ...
    object Entity { get; }
    /// <summary>
    /// Property that returns the ConstraintLimits object that provides access to various limits related settings for the iMate definition.
    /// </summary>
