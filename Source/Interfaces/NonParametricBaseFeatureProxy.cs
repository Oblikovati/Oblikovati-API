...
/// </summary>
public interface NonParametricBaseFeatureProxy
{
    /// <summary>
    ...
    /// </summary>
    SurfaceBodies InputSurfaceBodies { get; }
    /// <summary>
    /// Property that indicates if the non-parametric base feature is a composite of multiple solids and/or surfaces or is a single solid or surface.
    /// </summary>
    ...
    /// Missing documentation! Help us documenting it!
    /// </summary>
    SurfaceBody BaseSolidBody { get; }
    /// <summary>
    /// Gets the object in the context of the definition instead of the containing assembly.
    /// </summary>
    NonParametricBaseFeature NativeObject { get; }
    /// <summary>
    ...
    /// </summary>
    [PreserveSig]
    void DeleteFaces([In] [MarshalAs(UnmanagedType.Interface)] ObjectCollection Faces);
    /// <summary>
    ...
    /// </summary>
    /// <param name="BRepEntities">Input Object that defines the entity(s) that will replace the existing entity(s). The input for this argument must currently be a SurfaceBody object.</param>
    [PreserveSig]
    void Redefine([In] [MarshalAs(UnmanagedType.IDispatch)] object BRepEntities);
}
