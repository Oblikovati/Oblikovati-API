...
/// <summary>
/// The SweepFeature object represents swept modeling features. The properties and methods listed below are in addition to those supported by the Feature object.
/// </summary>
public interface SweepFeature
{
    /// <summary>
    ...
    /// Missing documentation! Help us documenting it!
    /// </summary>
    _SweepDefinition _Definition { get; }
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    SweepDefinitionTypeEnum DefinitionType { get; }
    /// <summary>
    /// Read-write property that gets and sets the SweepDefinition object associated with this sweep feature.
    /// </summary>
    SweepDefinition Definition { get; set; }
    /// <summary>
    /// Read-only property that returns whether the feature is a solid sweep feature.
    /// </summary>
    bool IsSolidSweep { get; }
    /// <summary>
    /// Read-write property that gets and sets the SolidSweepDefinition object associated with this sweep feature.
    /// </summary>
    SolidSweepDefinition SolidSweepDefinition { get; set; }
    /// <summary>
    ...
    [PreserveSig]
    void SetUsingPath([In] SweepProfileOrientationEnum? ProfileOrientation = SweepProfileOrientationEnum.kNormalToPath, [In] [MarshalAs(UnmanagedType.Struct)] object? TaperAngle = default);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    ...
    [PreserveSig]
    void SetUsingPathAndGuideRail([In] [MarshalAs(UnmanagedType.Interface)] Path GuideRail, [In] SweepProfileScalingEnum? ProfileScaling = SweepProfileScalingEnum.kXYProfileScaling);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    /// <param name="GuideSurface">GuideSurface</param>
    [PreserveSig]
    void SetUsingPathAndGuideSurface([In] [MarshalAs(UnmanagedType.IDispatch)] object GuideSurface);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    ...
    /// </summary>
    /// <param name="Occurrence">Input ComponentOccurrence object that specifies the participant to be added. An error occurs if the input ComponentOccurrence is not a leaf occurrence.</param>
    [PreserveSig]
