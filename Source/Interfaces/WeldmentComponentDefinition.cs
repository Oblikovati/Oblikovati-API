...
/// </summary>
public interface WeldmentComponentDefinition : ComponentDefinition
{
    /// <summary>
    ...
    /// </summary>
    Asset WeldEndFillAppearance { get; set; }
    /// <summary>
    ...
    /// </summary>
    Asset WeldBeadMaterial { get; set; }
    /// <summary>
    ...
    /// </summary>
    Asset WeldBeadAppearance { get; set; }
    /// <summary>
    ...
    [PreserveSig]
    RenderStyle GetEndFillRenderStyle([Out] out StyleSourceTypeEnum StyleSourceType);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    /// <param name="StyleSourceType">StyleSourceType</param>
    ...
    [PreserveSig]
    void SetEndFillRenderStyle([In] StyleSourceTypeEnum StyleSourceType, [In] [MarshalAs(UnmanagedType.Struct)] object? RenderStyle = default);
}
