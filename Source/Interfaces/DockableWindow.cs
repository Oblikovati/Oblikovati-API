...
public interface DockableWindow
{
    ...
    /// </summary>
    /// <param name="DockingState">Input DockingStateEnum value that specifies the docking state.</param>
    /// <param name="DockToObject">Optional input object to specify where the dockable window docks to. If the DockingState is specified as  kFloat  then this argument is ignored.</param>
    [PreserveSig]
