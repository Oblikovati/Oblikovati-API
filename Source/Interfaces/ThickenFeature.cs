...
/// <summary>
/// The ThickenFeature object represents a thicken feature, which is created interactively using the Thicken/Offset tool on the Part features toolbar. A thicken operation adds or removes volume from parts or adds thickness to surfaces to create parts.
/// </summary>
public interface ThickenFeature
{
    /// <summary>
    ...
    /// </summary>
    bool AutomaticFaceChain { get; }
    /// <summary>
    /// Property that gets whether or not to create vertical or "side" faces connecting the offset faces to the original work surface.
    /// </summary>
    bool CreateVerticalSurfaces { get; }
    /// <summary>
    /// Gets and sets the distance direction of the feature.
    /// </summary>
    PartFeatureExtentDirectionEnum Direction { get; set; }
    /// <summary>
    /// Property that returns the parameter that controls the thickness of the Thickness feature or the distance of the Offset feature.
    /// </summary>
    Parameter Distance { get; }
    /// <summary>
    /// Specifies the faces used to create the feature.
    /// </summary>
    object InputFaces { get; set; }
    /// <summary>
