...
/// </summary>
public interface SketchBlockDefinitionProxy
{
    /// <summary>
    ...
    /// </summary>
    SketchPoint InsertionPoint { get; }
    /// <summary>
    ...
    /// </summary>
    SketchBlockDefinition NativeObject { get; }
    /// <summary>
    ...
    /// </summary>
    /// <param name="SketchObject">Input object that specifies the object to trim the context of. This can be a SketchEntity, SketchBlock, SketchImage or a TextBox.</param>
    /// <returns></returns>
    [PreserveSig]
    object AdjustContext([In] [MarshalAs(UnmanagedType.IDispatch)] object SketchObject);
    /// <summary>
    /// Missing documentation! Help us documenting it!
    /// </summary>
    ...
    [PreserveSig]
    SketchBlockDefinition CopyTo([In] [MarshalAs(UnmanagedType.Interface)] _Document TargetDocument, [In] bool? Reserved = false);
}
