...
/// </summary>
public interface HorizontalConstraintProxy
{
    /// <summary>
    ...
    /// <summary>
    /// Property used in the case where the entity returned by the Entity property is an ellipse. This property specifies if the major or minor axis of the ellipse is horizontal. True if it is the major axis.
    /// </summary>
    bool UseEllipseMajorAxis { get; }
    /// <summary>
    /// Gets the object in the context of the definition instead of the containing assembly.
    /// </summary>
    HorizontalConstraint NativeObject { get; }
    /// <summary>
