...
/// </summary>
public interface MarkFeatureProxy
{
    /// <summary>
    ...
    /// <summary>
    /// Property that gets and sets the MarkDefinition object associated with this feature.
    /// </summary>
    MarkDefinition Definition { get; set; }
    /// <summary>
    /// Use F1 key to display help topic.
    /// </summary>
    MarkFeature NativeObject { get; }
    /// <summary>
    /// Use F1 key to display help topic.
    /// </summary>
    ...
    /// </summary>
    /// <param name="MarkGeometrySet">Optional input MarkGeometrySet object that returns the result edges of specified MarkGeometrySet. If no MarkGeometrySet is provided then all the result edges of the mark feature will be returned.</param>
    /// <returns></returns>
    [PreserveSig]
    Edges ResultEdges([In] [MarshalAs(UnmanagedType.Struct)] object? MarkGeometrySet = default);
}
