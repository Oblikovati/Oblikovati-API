...
/// </summary>
public interface PublicationFace
{
    /// <summary>
    ...
    /// <summary>
    /// Read-only property that returns all the PublicationEdge objects contained within the publication face.
    /// </summary>
    PublicationEdgesEnumerator Edges { get; }
    /// <summary>
    /// Read-only property that returns the SurfaceEvaluator for this publication face.
    /// </summary>
    SurfaceEvaluator Evaluator { get; }
    /// <summary>
    /// Read-only property that returns the PublicationFaceShell that this face is a part of.
    /// </summary>
    PublicationFaceShell FaceShell { get; }
    /// <summary>
    ...
    /// <summary>
    /// Read-only property that returns the publication body that this face is associative with.
    /// </summary>
    PublicationBody PublicationBody { get; }
    /// <summary>
    /// Read-only property that returns all the PublicationVertex objects contained within the publication face.
    /// </summary>
