...
/// </summary>
public interface UnfoldFeatureProxy
{
    /// <summary>
    ...
    /// </summary>
    Face StationaryFace { get; }
    /// <summary>
    /// Property that returns the sketches that were specifies as \input when creating this feature.
    /// </summary>
    SketchesEnumerator InputSketches { get; }
    /// <summary>
    /// Property that returns the sketches that were created as a \result of this feature. The ReferencedEntity property of the sketches returned will return the input sketch this result is based on.
    /// </summary>
    SketchesEnumerator ResultSketches { get; }
    /// <summary>
    ...
    [PreserveSig]
    void Edit([In] [MarshalAs(UnmanagedType.Interface)] Face StationaryFace, [In] [MarshalAs(UnmanagedType.Struct)] object? Bends = default, [In] [MarshalAs(UnmanagedType.Struct)] object? Sketches = default);
}
