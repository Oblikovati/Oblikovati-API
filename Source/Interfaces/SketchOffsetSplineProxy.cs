...
/// </summary>
public interface SketchOffsetSplineProxy
{
    /// <summary>
    ...
    /// <summary>
    /// Property that returns a geometry object. The object returned represents a "snapshot" view of the current state of the offset sketch spline.
    /// </summary>
    ...
    /// </summary>
    SketchSpline OriginalSpline { get; }
    /// <summary>
    /// Specifies whether curvature information is displayed for the offset spline.
    /// </summary>
    ...
    /// </summary>
    SketchOffsetSpline NativeObject { get; }
    /// <summary>
