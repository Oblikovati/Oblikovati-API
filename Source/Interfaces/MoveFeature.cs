...
/// <summary>
/// Use a MoveFeature object to move and rotate solid(SurfaceBody) and surface(WorkSurface) objects to a new location.
/// </summary>
public interface MoveFeature
{
    /// <summary>
    ...
    /// <summary>
    /// Gets and sets the definition for the move feature.
    /// </summary>
    MoveDefinition Definition { get; set; }
    /// <summary>
